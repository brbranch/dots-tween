...
namespace DotsTween.Tweens
{
    ...
    public struct TweenURPCutoffCommand : IComponentData, ITweenParams, ITweenInfo<float>
    {
        ...
        public TweenURPCutoffCommand(in float start, in float end, in float duration, TweenParams tweenParams = default)
        {
            tweenParams.Duration = duration;
            tweenParams.Id = tweenParams.GenerateId(TypeManager.GetTypeIndex<TweenURPCutoff>().Value);
