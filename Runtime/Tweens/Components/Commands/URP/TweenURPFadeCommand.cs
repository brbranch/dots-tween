...
namespace DotsTween.Tweens
{
    ...
    public struct TweenURPFadeCommand : IComponentData, ITweenParams, ITweenInfo<float>
    {
        ...
        public TweenURPFadeCommand(in float start, in float end, in float duration, TweenParams tweenParams = default)
        {
            tweenParams.Duration = duration;
            tweenParams.Id = tweenParams.GenerateId(TypeManager.GetTypeIndex<TweenURPFade>().Value);
