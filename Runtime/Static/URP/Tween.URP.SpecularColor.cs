    ...
    public static partial class Tween
    {
        public static partial class URP
        {
            ...
            public static class SpecularColor
            {
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenURPSpecularColorCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenURPSpecularColorCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenURPSpecularColorCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenURPSpecularColorCommand(start.ToFloat4(), end.ToFloat4(), duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenURPSpecularColorCommand(start.ToFloat4(), end.ToFloat4(), duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenURPSpecularColorCommand(start.ToFloat4(), end.ToFloat4(), duration, tweenParams));
                }
