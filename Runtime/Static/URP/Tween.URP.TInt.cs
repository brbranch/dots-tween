    ...
    public static partial class Tween
    {
        public static partial class URP
        {
            ...
            public static class Tint
            {
                ...
                {
                    var command = new TweenURPTintCommand(start, end, duration, tweenParams);
                ...
                {
                    var command = new TweenURPTintCommand(start.ToFloat4(), end.ToFloat4(), duration, tweenParams);
                    state.EntityManager.AddComponentData(entity, command);
                    return command.TweenParams.Id;
                }
