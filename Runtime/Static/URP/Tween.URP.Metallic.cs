    ...
    public static partial class Tween
    {
        public static partial class URP
        {
            ...
            public static class Metallic
            {
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenURPMetallicCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenURPMetallicCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenURPMetallicCommand(start, end, duration, tweenParams));
                }
