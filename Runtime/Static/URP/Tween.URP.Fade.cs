    ...
    public static partial class Tween
    {
        public static partial class URP
        {
            ...
            public static class Fade
            {
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenURPFadeCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenURPFadeCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenURPFadeCommand(start, end, duration, tweenParams));
                }
