    ...
    public static partial class Tween
    {
        public static partial class URP
        {
            ...
            public static class BumpScale
            {
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenURPBumpScaleCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenURPBumpScaleCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenURPBumpScaleCommand(start, end, duration, tweenParams));
                }
