    ...
    public static partial class Tween
    {
        public static partial class URP
        {
            ...
            public static class OcclusionStrength
            {
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenURPOcclusionStrengthCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenURPOcclusionStrengthCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenURPOcclusionStrengthCommand(start, end, duration, tweenParams));
                }
