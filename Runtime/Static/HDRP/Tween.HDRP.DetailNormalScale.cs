    ...
    public static partial class Tween
    {
        public static partial class HDRP
        {
            ...
            public static class DetailNormalScale
            {
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenHDRPDetailNormalScaleCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenHDRPDetailNormalScaleCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenHDRPDetailNormalScaleCommand(start, end, duration, tweenParams));
                }
