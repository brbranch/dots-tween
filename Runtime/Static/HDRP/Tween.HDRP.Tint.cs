    ...
    public static partial class Tween
    {
        public static partial class HDRP
        {
            ...
            public static class Tint
            {
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenHDRPTintCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenHDRPTintCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenHDRPTintCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenHDRPTintCommand(start.ToFloat4(), end.ToFloat4(), duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenHDRPTintCommand(start.ToFloat4(), end.ToFloat4(), duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenHDRPTintCommand(start.ToFloat4(), end.ToFloat4(), duration, tweenParams));
                }
                ...
                {
                    currentValue = state.EntityManager.GetComponentData<HDRPMaterialPropertyBaseColor>(entity).Value;
                }
            }
        }
    }
