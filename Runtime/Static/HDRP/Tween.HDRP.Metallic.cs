    ...
    public static partial class Tween
    {
        public static partial class HDRP
        {
            ...
            public static class Metallic
            {
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenHDRPMetallicCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenHDRPMetallicCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenHDRPMetallicCommand(start, end, duration, tweenParams));
                }
