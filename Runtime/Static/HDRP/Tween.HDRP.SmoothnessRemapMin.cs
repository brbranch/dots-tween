    ...
    public static partial class Tween
    {
        public static partial class HDRP
        {
            ...
            public static class SmoothnessRemapMin
            {
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenHDRPSmoothnessRemapMinCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenHDRPSmoothnessRemapMinCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenHDRPSmoothnessRemapMinCommand(start, end, duration, tweenParams));
                }
