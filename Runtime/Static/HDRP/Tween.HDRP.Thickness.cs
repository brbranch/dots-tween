    ...
    public static partial class Tween
    {
        public static partial class HDRP
        {
            ...
            public static class Thickness
            {
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenHDRPThicknessCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenHDRPThicknessCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenHDRPThicknessCommand(start, end, duration, tweenParams));
                }
