    ...
    public static partial class Tween
    {
        public static partial class HDRP
        {
            ...
            public static class SpecularColor
            {
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenHDRPSpecularColorCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenHDRPSpecularColorCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenHDRPSpecularColorCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenHDRPSpecularColorCommand(start.ToFloat4(), end.ToFloat4(), duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenHDRPSpecularColorCommand(start.ToFloat4(), end.ToFloat4(), duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenHDRPSpecularColorCommand(start.ToFloat4(), end.ToFloat4(), duration, tweenParams));
                }
                ...
                {
                    currentValue = state.EntityManager.GetComponentData<HDRPMaterialPropertySpecularColor>(entity).Value;
                }
            }
        }
    }
