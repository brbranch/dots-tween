    ...
    public static partial class Tween
    {
        public static partial class HDRP
        {
            ...
            public static class SpecularColor
            {
                ...
                {
                    var command = new TweenHDRPSpecularColorCommand(entity, start, end, duration, tweenParams);
                ...
                {
                    var command = new TweenHDRPSpecularColorCommand(entity, start.ToFloat4(), end.ToFloat4(), duration, tweenParams);
                    state.EntityManager.AddComponentData(entity, command);
                    return command.TweenParams.Id;
                }
