    ...
    public static partial class Tween
    {
        public static partial class HDRP
        {
            ...
            public static class DetailSmoothnessScale
            {
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenHDRPDetailSmoothnessScaleCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenHDRPDetailSmoothnessScaleCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenHDRPDetailSmoothnessScaleCommand(start, end, duration, tweenParams));
                }
