    ...
    public static partial class Tween
    {
        public static partial class HDRP
        {
            ...
            public static class AlphaCutoff
            {
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenHDRPAlphaCutoffCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenHDRPAlphaCutoffCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenHDRPAlphaCutoffCommand(start, end, duration, tweenParams));
                }
