    ...
    public static partial class Tween
    {
        public static partial class HDRP
        {
            ...
            public static class Fade
            {
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenHDRPFadeCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenHDRPFadeCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenHDRPFadeCommand(start, end, duration, tweenParams));
                }
