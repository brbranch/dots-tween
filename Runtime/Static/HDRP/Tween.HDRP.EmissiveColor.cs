    ...
    public static partial class Tween
    {
        public static partial class HDRP
        {
            ...
            public static class EmissiveColor
            {
                ...
                {
                    var command = new TweenHDRPEmissiveColorCommand(start.xyz, end.xyz, duration, tweenParams);
                ...
                {
                    var command = new TweenHDRPEmissiveColorCommand(start, end, duration, tweenParams);
                    state.EntityManager.AddComponentData(entity, command);
                    return command.TweenParams.Id;
                }
                ...
                {
                    var command = new TweenHDRPEmissiveColorCommand(start.ToFloat3(), end.ToFloat3(), duration, tweenParams);
                    state.EntityManager.AddComponentData(entity, command);
                    return command.TweenParams.Id;
                }
