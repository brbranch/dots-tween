    ...
    public static partial class Tween
    {
        public static partial class HDRP
        {
            ...
            public static class AmbientOcclusionRemapMin
            {
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenHDRPAmbientOcclusionRemapMinCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenHDRPAmbientOcclusionRemapMinCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenHDRPAmbientOcclusionRemapMinCommand(start, end, duration, tweenParams));
                }
