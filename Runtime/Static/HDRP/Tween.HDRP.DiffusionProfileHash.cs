    ...
    public static partial class Tween
    {
        public static partial class HDRP
        {
            ...
            public static class DiffusionProfileHash
            {
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenHDRPDiffusionProfileHashCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenHDRPDiffusionProfileHashCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenHDRPDiffusionProfileHashCommand(start, end, duration, tweenParams));
                }
