    ...
    public static partial class Tween
    {
        public static partial class HDRP
        {
            ...
            public static class FadeUnlit
            {
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenHDRPFadeUnlitCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenHDRPFadeUnlitCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenHDRPFadeUnlitCommand(start, end, duration, tweenParams));
                }
