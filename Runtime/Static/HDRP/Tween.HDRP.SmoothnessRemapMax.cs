    ...
    public static partial class Tween
    {
        public static partial class HDRP
        {
            ...
            public static class SmoothnessRemapMax
            {
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenHDRPSmoothnessRemapMaxCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenHDRPSmoothnessRemapMaxCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenHDRPSmoothnessRemapMaxCommand(start, end, duration, tweenParams));
                }
