    ...
    public static partial class Tween
    {
        public static partial class HDRP
        {
            ...
            public static class Smoothness
            {
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenHDRPSmoothnessCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenHDRPSmoothnessCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenHDRPSmoothnessCommand(start, end, duration, tweenParams));
                }
