    ...
    public static partial class Tween
    {
        public static partial class HDRP
        {
            ...
            public static class DetailAlbedoScale
            {
                ...
                {
                    state.EntityManager.AddComponentData(entity, new TweenHDRPDetailAlbedoScaleCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(entity, new TweenHDRPDetailAlbedoScaleCommand(start, end, duration, tweenParams));
                }
                ...
                {
                    ecb.AddComponent(sortKey, entity, new TweenHDRPDetailAlbedoScaleCommand(start, end, duration, tweenParams));
                }
